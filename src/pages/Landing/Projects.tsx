    ...
    >
      ...
      >
        ...
        <Box p={4}>
          ...
          <Text color={"gray.500"} noOfLines={3}>
            Site de acompanhantes particular de portugal'EM PRODUÇÃO!',
            finalizando ajustes e db.
          </Text>
        </Box>
      ...
      >
        ...
        <Box p={4}>
          ...
          <Text color={"gray.500"} noOfLines={3}>
            Futura Nexly, plataforma de membros streamer on demand, grande
            projeto que está em produção!
          </Text>
        </Box>
        <HStack borderTop={"1px"} color="black">
          <Link
      ...
      >
        ...
        <Box p={4}>
          ...
          <Text color={"gray.500"} noOfLines={3}>
            Grande mercado de portugal, fomos responsáveis por modificações no
            site e ajustes no db do site da empresa.
          </Text>
        </Box>
        <HStack borderTop={"1px"} color="black">
          <Link
